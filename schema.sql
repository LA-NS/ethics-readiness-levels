-- LPERL Assessment Tool Database Schema
...
-- LPERL Assessment Questions - Actual Data
...
(1493, '10.1.2', 'Is personal data only retained for the purpose of responding to potential future requests?', 0, -0.05, 'gdpr_block'),
(1494, '11', 'Does the product support the "right to be forgotten," allowing for the erasure of personal data?', 0, -0.54, 'gdpr_block'),
...
(1505, '12.1.2', 'Is the consent mechanism presented separately from other terms or conditions?', 0, -0.05, 'gdpr_block'),
...
INSERT OR REPLACE INTO questions (id, number, question, yes_score, no_score, block) VALUES
(1515, '15', 'Does the product handle personal data?', -0.5, 0, 'led_block'),
...
(1519, '15.2', 'Does your product process data related to a person''s racial or ethnic background?', -0.333, 0, 'led_block'),
...
(1525, '17', 'Can users ask to verify the lawfulness of the data processing?', 0, -0.35, 'led_block'),
(1526, '17.1', 'Are users informed that they have the right to check if data processing is lawful?', 0, -0.225, 'led_block'),
...
(1539, '18.1', 'Does it comply with relevant requirements for high-risk systems in the AI Act or includes a compliance plan for the upcoming regulation?', 0, 0, 'ai_block'),
...
(1546, '20', 'Do users get sufficient information about the methods and capabilities of the AI system?', 0, -0.25, 'ai_block'),
...
(1560, '22.1', 'Is the training and application data stored securely with standard and robust authorisation and encryption requirements?', 0.171, 0, 'ai_block'),
...
(1565, '23.1', 'Was the training specifically adapted and contextualized for the use case?', 0, -0.023, 'ai_block'),
